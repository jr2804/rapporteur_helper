...
from rapporteur_helper.data.constants import hostname
from rapporteur_helper.html import get_html_tree

# TODO: This is ugly - there should be a better way to parse month names than hardcoding them in a dict, but it works for now
MONTHS = {
    "January": 1,
    "February": 2,
    "March": 3,
...
@dataclass
class MeetingInfo:
    """Meeting information with place and dates."""
...
def get_sg_page_url(study_group: int, study_period: str = "2025-2028") -> str:
    """Build URL for a study group page."""
